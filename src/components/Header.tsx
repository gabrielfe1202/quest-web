      ...
      <div className="flex flex-row gap-10">
        <div className="flex-row hidden md:flex gap-6">
          <div className="bg-yellow-200 flex flex-row justify-between p-2 rounded-full">
            <p className="mx-8 font-bold text-3xl text-amber-500">58º</p>
        ...
        <div>
          <div className="relative">
            ...
            >
              <div className="absolute right-0 mt-9 w-48 border-0 rounded-md shadow-lg z-20 bg-gray-800 text-white">
                <div className="py-2">
                  <button onClick={() => { }} className="block px-4 py-2 w-full text-white border-white" style={{borderBottom: '1px solid #fff'}}>
                    Perfil
                  </button>
                  <button onClick={() => { localStorage.removeItem("userId"), navigate('/login') }} className="block px-4 py-2 w-full text-white">
                    Sair
                  </button>
                </div>
              </div>
